...
module.exports = async (message) => {
    ...
    if (message.MsgType === 'text') {
        ...
        content = '即将转取您银行卡的7000元 \n回复2 确认转取 \n回复3 不用确认'
            ...
            //上传临时图片素材
            const data = await materailApi.uploadMaterial('image', __dirname + '/0.png')
            ...
            //上传临时图片素材
            const data = await materailApi.uploadMaterial('image', __dirname + '/0.png', true)
            // console.log(data)  //得到上传临时图片素材media_id
            const newsList = {
                articles: [{
                    title: '微信公众号开发',
            ...
            content = '<a href="http://beb88bbd.ngrok.io/movie">语音识别</a>'
        }
